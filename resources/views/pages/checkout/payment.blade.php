...
<section id="cart_items">
		<div class="container">
			...
			<h4 style="margin:40px 0;font-size: 20px;">Choose method payment</h4>
			...
			<div class="payment-options">
					...
					<span>
						<label><input name="payment_option" value="2" type="checkbox"> Pay with cash</label>
					</span>					
					<input type="submit" value="Send order" name="send_order_place" class="btn btn-primary btn-sm">
			</div>
			</form>
		</div>
	</section> <!--/#cart_items-->
