...
class CartController extends Controller
{
    public function check_coupon(Request $request){
        ...
        if($coupon){
            ...
            return redirect()->back()->with('error','The discount code is incorrect');
        }
    }   
    ...
    public function update_cart(Request $request){
        ...
        if($cart==true){
            ...
            return redirect()->back()->with('message','Update quantity of failures');
        }
    }
    ...
    public function delete_all_product(){
        ...
        if($cart==true){
            ...
            return redirect()->back()->with('message','Successfully cleared all cart');
        }
    }
