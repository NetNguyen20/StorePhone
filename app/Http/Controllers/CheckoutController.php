...
class CheckoutController extends Controller
{
    ...
    public function confirm_order(Request $request){
         ...
         $title_mail = "The oreder confimed on".''.$now;
         ...
         Mail::send('pages.mail.mail_order', ['cart_array' => $cart_array, 'shipping_array' =>$shipping_array, 'code'=>$ordercode_email], function($message) use ($title_mail, $data){
    ...
    public function checkout(Request $request){
        ...
        ->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)
        ->with('url_canonical',$url_canonical)->with('city',$city)->with('slider',$slider)->with('menu_post',$menu_post);
    }
